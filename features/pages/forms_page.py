...
class FormsPage(BasePage):
    ...
    def menu_forms_tap(self):
        BasePage().wait_element_to_be_clickable(None, self.menu_forms)
        self.menu_forms_tap = self.driver.find_element_by_xpath(self.menu_forms)
        BasePage().tap_element(self.menu_forms_tap)
    ...
    def switch_time_tap(self):
        ...
        BasePage().tap_element(self.switch_time_tap)
    ...
    def save_lazy_tap(self):
        ...
        BasePage().tap_element(self.save_lazy_tap)
        BasePage().wait_visibility_of_element_located(None, f"//android.widget.TextView[@text='Console: ps4']")

    def verify_text_in_screen(self, message):
        BasePage().wait_element_to_be_clickable(None, f"//android.widget.TextView[@text='Console: ps4']")
    ...
    def button_clear_tap(self):
        ...
        BasePage().tap_element(self.button_clear_tap)
